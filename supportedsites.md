# Supported Sites — SolaDownload v3.6.6

> Danh sách các trang web được hỗ trợ bởi **SolaDownload**, được cập nhật theo phiên bản yt-dlp mới nhất.
> List of websites supported by **SolaDownload**, synced with the latest yt-dlp release.
>
> Source: [yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp) — Last updated: June 2025
